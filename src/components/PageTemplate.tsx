...
import type { PageData } from '@/data/pages-data'

interface PageTemplateProps {
  data: PageData
  section: 'travellers' | 'corporate'
  breadcrumbLabel: string
}

export default function PageTemplate({ data, section, breadcrumbLabel }: PageTemplateProps) {
  return (
        ...
        <div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
              ...
              {/* Related Links */}
              <div className="bg-white rounded-2xl shadow-sm border border-neutral-200 p-6">
                <h3 className="text-lg font-bold text-neutral-900 mb-4">Related Pages</h3>
