            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <span className="text-red-200 font-medium">Corporate Solutions</span>
                </div>
                  ...
                  {featuredServices.map((service, index) => (
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <h3 className="font-semibold text-white group-hover:text-red-100 transition-colors">
                          {service.title}
                        </h3>
                        <p className="text-sm text-red-100">{service.description}</p>
                      </div>
                      <ArrowRight className="w-5 h-5 text-red-200 group-hover:text-white group-hover:translate-x-1 transition-all" />
                    </Link>
                  ))}
                </div>
              </div>
